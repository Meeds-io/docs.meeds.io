...
3. **Options Available:**
   ...
   * **Filter List Options:**
     * Any space.
     * Filter by templates (see [managing-space-templates.md](managing-space-templates.md "mention")) .
     * Filter by category and customize related filters  (see [managing-categories.md](../advanced-customization/managing-categories.md "mention")).
