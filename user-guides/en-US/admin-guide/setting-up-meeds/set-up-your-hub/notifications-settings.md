...
:bulb: Just like notification channels, each user can then [disable notifications at their convenience](../../../user-guide/exploring-a-meeds-hub/navigating/updating-your-notifications.md) or specify the channel to use.
