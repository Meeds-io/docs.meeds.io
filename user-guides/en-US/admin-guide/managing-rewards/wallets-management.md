...
* Find the current balance of the Hub's Wallet (Meeds/Gas)
* Click on 'Wallet Address' then copy the displayed address
* Deposit  MEED tokens and gas  (MATIC/POL) to this address on the Polygon network&#x20;
* Once the funds are transferred, the balance will be updated

:bulb: **This hubs wallet is secured, but it's managed by the Hub, hence you don't own it. Make sure you only send reasonable amounts of tokens as you will NOT be able to withdraw them**

### **List Activated Wallets**

* From wallet management, find the list of user wallets referenced the hub.
* Activated wallets are listed alphabetically.
* Information includes:
  * User's name
  * Wallet status based on the current balance (MEED and/or MATIC)
